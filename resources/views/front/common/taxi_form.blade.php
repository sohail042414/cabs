...
<b> You may make a boooking here, or you may call us at 
    ...
    {{ csrf_field() }}
        ...
        <div class="row" style="" id="geo-from-wrap">
            ...
            <label>From </label>        
                ...
                <input type="text" id="from_address" name="from_address" value="{{ old('from_address') }}"
                    aria-required="true" aria-invalid="false" placeholder="eg. Ambri Airport ....">
                    ...
                    <div class="form-input"> 
                        <div class="row">
                            <div class="col-md-4" style="padding-right: 0px !important;">
                                <select id="booking-time-hours" name="booking_hours" class="form-select">                    
                                    @for($number = 1;$number<=23; $number++)
                                        <option @if(old('booking_hours') ==$number) selected="selected" @endif value="{{ sprintf('%02d', $number) }}">{{ sprintf('%02d', $number) }}</option>
                                    @endfor                        
                                    <option @if(old('booking_hours') =='00') selected="selected" @endif value="00">00</option>
                                </select>
                            </div>
                            <div class="col-md-4" style="padding-left:0px !important;">
                                <select id="booking-time-minutes" name="booking_minutes" class="form-select">                    
                                    @for($number = 0;$number<=59; $number+=10)
                                        <option @if(old('booking_hours') ==$number) selected="selected" @endif value="{{ sprintf('%02d', $number) }}">{{ sprintf('%02d', $number) }}</option>
                                    @endfor                        
                                </select>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5" id="terminal-wrap" style="display:none;">
