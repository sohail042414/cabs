<footer>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <ul class="social-icons-list">
              <li><a href="javascript:void();"><span class="fa fa-phone"></span>{{ config('settings.phone', '0782045470') }}</a></li>
              <li><a href="javascript:void();"><span class="fa fa-envelope"></span>{{ config('settings.contact_us_email', 'info@rayantransports.com') }}</a></li>
    ...
    <section class="footer-block">
      <div class="container">
        <p>
          <a href="/terms-conditions">{{ config('app.name', 'Rayan Transports') }}</a> 2022 © All Rights Reserved <a href="/terms-conditions">Terms of use</a>
        </p>
