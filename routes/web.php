...
Route::get('/paypal-start', 'BookingController@paypalStart');


 //display booking it is open for any user for now
Route::get('/booking-detail/{booking_id}', 'BookingController@bookingDetail');

Route::get('/booking-payment/{booking_id}', 'BookingController@bookingPayment');
...
Route::group(['middleware' => 'CustomerCheck'], function () {
    ...
    //Route::get('/booking-detail/{booking_id}', 'CustomerController@detail');
     ...
     Route::get('/cash-payment/{booking_id}', 'BookingController@cashPayment');
});
